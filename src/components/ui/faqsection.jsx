            ...
            <div className="mx-auto w-full max-w-6xl rounded-3xl bg-white p-5 backdrop-blur-xl md:p-8 dark:bg-[#0f172a]/70">
                <div className="grid grid-cols-1 gap-8 md:grid-cols-[0.92fr_1.08fr] md:gap-10">
                    <div className="flex h-full flex-col">
                        <p className="inline-flex w-fit self-start items-center rounded-full px-3 py-1 text-[11px] font-medium tracking-[0.06em] text-violet-700 dark:text-violet-200">
                            {subtitle}
                        </p>
                        ...
                        <div className="relative mt-8 overflow-hidden rounded-2xl bg-slate-50 p-5 md:mt-auto dark:bg-linear-to-br dark:from-black dark:via-zinc-950 dark:to-zinc-900">
